...
public class TwitterDialog extends Dialog {
	...
	public TwitterDialog(Context context, String url, Twitter_Handler.TwDialogListener listener) {
		super(context);
	...
	private void setUpTitle() {
		...
		Drawable icon = getContext().getResources().getDrawable(R.drawable.twitter_share);
